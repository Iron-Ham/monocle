...
/// Fetches signature and documentation for a Swift symbol without resolving its definition.
struct HoverCommand: AsyncParsableCommand {
  ...
  /// Runs the hover command and prints results in the requested format.
